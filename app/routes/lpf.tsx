...
import { logout, useOptionalUser } from "~/utils";
...
export default function lpfIndexPage() {
  ...
  return (
    ...
    <h2 className="text-lg">
     Hi <span className="font-bold">{user?.email}</span>, Welcome to Lost Pet Finders
    </h2>
    <div className="m-auto">
      <h1 className="text-xl text-center font-bold h1">Recently spotted pets </h1>
      { isLoaded ? (
      <GoogleMap
    ...
    <div>
      <h1>Think you've seen someone's Pet ?</h1>
